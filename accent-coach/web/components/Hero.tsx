...
export function Hero({ onRunDemo, isDemoLoading }: HeroProps) {
  return (
    ...
    >
      <p className="text-xs uppercase tracking-[0.3em] text-white/70">FrontlineReady</p>
      <h1 className="mt-5 text-4xl font-semibold leading-tight md:text-5xl">
        Be job-ready. Confident. Clear.
      </h1>
      <p className="mt-4 max-w-2xl text-lg text-white/80">
        Build workplace communication skills that get you hired and keep customers happy. Practice clarity, customer care, and interviews—all on your terms.
      </p>
      <div className="mt-10 flex flex-wrap items-center gap-3">
        ...
        >
          <Play className="h-4 w-4" /> {isDemoLoading ? "Loading…" : "Try demo"}
        </Button>
      </div>
    </motion.section>
  );
